class Enemy {
  ...
  static originalSpawnOptions = [
    ...
    { spawn: { x: 1090, y: 500 },  patrol: [{ x: 1020, y: 500 }, { x: 560, y: 500 }] },
    { spawn: { x: -10, y: 500 },  patrol: [{ x: 100, y: 500 }, { x: 500, y: 500 }] },
    { spawn: { x: 1090, y: 450 },  patrol: [{ x: 1020, y: 450 }, { x: 560, y: 450 }] },
    { spawn: { x: -10, y: 450 },  patrol: [{ x: 100, y: 450 }, { x: 500, y: 450 }] },
